...
exports.Mutation = schema_1.mutationType({
    definition: function (t) {
        ...
        t.field("createProfile", {
            type: "Profile",
            args: {
                bio: schema_1.stringArg(),
                location: schema_1.stringArg(),
                website: schema_1.stringArg(),
                avatar: schema_1.stringArg()
            },
        ...
        t.field("follow", {
            ...
            args: {
                ...
                followId: schema_1.intArg({ nullable: false }),
                avatar: schema_1.stringArg({ nullable: false })
            },
            resolve: function (parent, _a, ctx) {
                var name = _a.name, followId = _a.followId, avatar = _a.avatar;
                var userId = utils_1.getUserId(ctx);
                if (!userId)
                    throw new Error("Could not authenticate user.");
